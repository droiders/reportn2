...
{	
    		...
    		case R.id.newssettings:
    			...
    			builder.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() {
    				public void onClick(DialogInterface dialog, int item) {
    					...
    					{
    					case 0:
    						editor.putString("EXFEED", "http://www.tap.info.tn/fr/fr/politique.feed?type=rss");
    						break;
    					case 1:
    						editor.putString("EXFEED", "http://www.tap.info.tn/fr/fr/economie.feed?type=rss");
    						break;
    					case 2:
    						editor.putString("EXFEED", "http://www.tap.info.tn/fr/fr/component/content/section/23.feed?layout=blog&type=rss");
    						break;
    					}
    					editor.commit();
    					alert.cancel();
    ...
    {
    	String ret = null;
    	ret = pref.getString("EXFEED", "http://www.tap.info.tn/fr/fr/politique.feed?type=rss");
	...
	private class DownloadFeedTask extends AsyncTask<String, Void, RSSFeed> 
	{
		...
		protected void onPreExecute() {
			dialog = ProgressDialog.show(RSSExampleActivity.this, "Recherche du flux...", "Chargement");
